            ...
            while (!shuttingDown.get()) {
                ...
                try {
                    ...
                    if ((now - lastTime) > 10000L) {
                        lastTime = now;
                        log.info("saveThreads = {} toProcess = {} , toBroadcast = {} , toRequest = {} , toReply = {} / totalTransactions = {}", Tangle.instance().getActiveThreads(), getReceiveQueueSize(), getBroadcastQueueSize() ,TransactionRequester.instance().numberOfTransactionsToRequest() ,getReplyQueueSize(), TransactionViewModel.getNumberOfStoredTransactions());
                    }
